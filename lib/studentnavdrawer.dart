...
class StudNavDrawer extends StatefulWidget {
  StudNavDrawer({Key key, this.auth, this.userId, this.userManager, this.user})
      : super(key: key);
...
class _NavDrawerState extends State<StudNavDrawer> {
