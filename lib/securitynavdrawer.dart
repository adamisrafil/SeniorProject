...
class SecNavDrawer extends StatefulWidget {
  SecNavDrawer({Key key, this.auth, this.userId, this.userManager, this.user})
      : super(key: key);
...
class _NavDrawerState extends State<SecNavDrawer> {
